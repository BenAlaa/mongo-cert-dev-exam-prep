...
5. [M320: Data Modeling](#m320)
   1. [Chapter 1: Introduction to Data Modeling](#m320-ch1)
      - [Data Modeling in MongoDB](#m320-data-modeling)
      - [The Document Model in MongoDB](#m320-doc-model)
      - [Constraints in Data Modeling](#m320-constraints)
      - [The Data Modeling Methodology](#m320-methodology)
      - [Model for Simplicity or Performance](#m320-simplicity-or-performance)
   2. [Chapter 2: Relationships](#m320-ch2)
      - [Introduction to Relationships](#m320-relationship-intro)
      - [Relationship Types and Cardinality](#m320-cardinality)
      - [One-to-Many Relationship](#m320-1-N)
      - [Many-to-Many Relationship](#m320-N-N)
      - [One-to-One Relationship](#m320-1-1)
      - [One-to-Zillions Relationship](#m320-1-Z)
   3. [Chapter 3: Patterns](#m320-ch3)
      - [Introduction to Patterns](#m320-patterns-intro)
      - [Handling Duplication, Staleness and Integrity](#m320-dupl-stale-integr)
      - [Attribute Pattern](#m320-attribut-pattern)
      - [Extended Reference Pattern](#m320-extended-ref-pattern)
      - [Subset Pattern](#m320-subset=pattern)
      - [Computed Pattern](#m320-computed-pattern)
      - [Bucket Pattern](#m320-bucket-pattern)
      - [Schema Versioning Pattern](#m320-schema-versioning)
      - [Tree Patterns](#m320-tree)
      - [Polymorphic Pattern](#m320-poly)
      - [Other Patterns](#m320-other)
      - [Summary of Patterns](#m320-summary)
...
# M320: Data Modeling <a id="m320"></a>
Learn everything you need to know about data modeling for MongoDB.

## Chapter 1: Introduction to Data Modeling <a id="#m320-ch1"></a>

### Data Modeling in MongoDB <a id="#m320-data-modeling"></a>
...
### The Document Model in MongoDB <a id="#m320-doc-model"></a>
...
### Constraints in Data Modeling <a id="#m320-constraints"></a>
...
### The Data Modeling Methodology <a id="#m320-methodology"></a>
...
### Model for Simplicity or Performance <a id="#m320-simplicity-or-performance"></a>
...
## Chapter 2: Relationships <a id="#m320-ch2"></a>

### Introduction to Relationships <a id="#m320-relationship-intro"></a>
...
### Relationship Types and Cardinality <a id="#m320-cardinality"></a>
...
### One-to-Many Relationship <a id="#m320-1-N"></a>
...
### Many-to-Many Relationship <a id="#m320-N-N"></a>
...
### One-to-One Relationship <a id="#m320-1-1"></a>
...
### One-to-Zillions Relationship <a id="#m320-1-Z"></a>
...
## Chapter 3: Patterns <a id="#m320-ch3"></a>

### Introduction to Patterns <a id="#m320-patterns-intro"></a>
...
### Handling Duplication, Staleness and Integrity <a id="#m320-dupl-stale-integr"></a>
...
### Attribute Pattern <a id="#m320-attribut-pattern"></a>
...
### Extended Reference Pattern <a id="#m320-extended-ref-pattern"></a>
...
### Subset Pattern <a id="#m320-subset=pattern"></a>
**Problem**:
...
### Computed Pattern <a id="#m320-computed-pattern"></a>
**Problem**:
...
### Bucket Pattern <a id="#m320-bucket-pattern"></a>
**Problem**:
...
### Schema Versioning Pattern <a id="#m320-schema-versioning"></a>
...
### Tree Patterns <a id="#m320-tree"></a>
**Problem**:	
...
### Polymorphic Pattern <a id="#m320-poly"></a>
...
### Other Patterns <a id="#m320-other"></a>
...
### Summary of Patterns <a id="#m320-summary"></a>
